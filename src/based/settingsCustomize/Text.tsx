import { fontFamilyOptions, fontSizeOptions, fontWeightOptions } from '@/based/constant';
...
const RenderSelect = ({ config, fontSize, fontWeight, fontFamily, handleInputChange }: Props) => (
  ...
  >
    <SelectTrigger className="no-ring w-full rounded-sm border border-primary-grey-200">
      <SelectValue placeholder={config.property === 'fontFamily' ? 'Choose a font' : config.property === 'fontSize' ? '30' : 'Semibold'} />
    </SelectTrigger>
